...
/*   Updated: 2024/05/14 13:56:58 by bekhodad         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "Cat.hpp"

Cat::Cat() : Animal(), _type("Cat") {std::cout << C << BLU << "This is Cat constructor\n" << RES;}
...
Cat::~Cat(){std::cout << C << BLU << "this is Cat destructor\n" << RES;}